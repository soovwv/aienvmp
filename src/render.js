...
import { dashboardAgentClientScript, dashboardDependencyReviewClientScript, dashboardPriorityClientScript, dashboardReviewPlanClientScript, dashboardScannerGuidanceClientScript } from "./dashboard.js";

const markerBegin = "<!-- aienvmp:begin -->";
const markerEnd = "<!-- aienvmp:end -->";

export { markerBegin, markerEnd };
export { dashboardAgentClientScript, dashboardCardPriority, dashboardDependencyReviewClientScript, dashboardEssentialCards, dashboardPriorityClientScript, dashboardReviewPlanClientScript, dashboardScannerGuidanceClientScript } from "./dashboard.js";
