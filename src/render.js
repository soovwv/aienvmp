...
export function renderPlan(plan) {
  ...
  const lines = [
    ...
    `Follow-up plan: ${followUpPlan.status || "clear"} / ${followUpPlan.nextCommand || "aienvmp status --json"}`,
