...
test("dashboardDocument wraps escaped payload and client script", () => {
  const html = dashboardDocument('{"name":"<sample>"}', "window.__aienvmp=true;");
